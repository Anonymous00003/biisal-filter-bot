...
<code>/font hi how are you</code></b>"""
    ...
    PREMIUM_TEXT = """<b>🍿 ᴇxᴘʟᴏʀᴇ, <blockquote style="font-size: 30px;">🎬<u> ᴍᴏᴠɪᴇ </u></blockquote>
    
          <u>ʙᴏʟʟʏᴡᴏᴏᴅ ᴍᴏᴠɪᴇs</u>
○<span style="font-size: 24px;">ᴀ</span>: <code>ᴀsʜᴏᴋᴀ ᴛʜᴇ ɢʀᴇᴀᴛ (2001)</code>
     <code>ᴀxᴏɴᴇ (2020)</code>
     <code>ᴀ ɢᴇɴᴛʟᴇᴍᴀɴ (2017)</code>
     <code>ᴀʙᴄᴅ (ᴀɴʏ ʙᴏᴅʏ ᴄᴀɴ ᴅᴀɴᴄᴇ)</code>
     <code>ᴀᴄᴛɪᴏɴ ᴊᴀᴄᴋsᴏɴ (2014)</code>
     ᴀɢᴇɴᴛ ᴠɪɴᴏᴅ (2012)
     ᴀᴀᴘ ᴍᴜᴊʜᴇ ᴀᴄʜᴄʜᴇ ʟᴀɢɴᴇ ʟᴀɢᴇ (2002)
     ʙᴜʟʙʙᴜʟ (2020)
     ʙʜᴏɴsʟᴇ (2020)
     </b>"""
...
ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ ʙᴜʏɪɴɢ ↡↡↡
    ...
    EARN_TEXT = """<b>Tʜɪs ɪs ᴀɴ ᴏᴘᴇɴ-sᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ.

ᴀʟʟ ғɪʟᴇs ɪɴ tʜɪs ʙᴏᴛ ᴀʀᴇ ғʀᴇᴇʟʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴛʜᴇ ɪɴᴛᴇʀɴᴇᴛ ᴏʀ ᴘᴏsᴛᴇᴅ ʙʏ tʜɪʀᴅ ᴘᴀʀᴛɪᴇs. tʜɪs ʙᴏᴛ ɪɴᴅᴇxᴇs ғɪʟᴇs tʜᴀᴛ ʜᴀᴠᴇ ᴀʟʀᴇᴀᴅʏ ʙᴇᴇɴ ᴜᴘʟᴏᴀᴅᴇᴅ ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ ғᴏʀ ᴇᴀsɪᴇʀ sᴇᴀʀᴄʜɪɴɢ. Wᴇ ғᴜʟʟʏ ʀᴇsᴘᴇᴄᴛ ᴄᴏᴘʏʀɪɢʜᴛ ʟᴀᴡs ᴀɴᴅ ᴄᴏᴍᴘʟʏ ᴡɪᴛʜ Dᴍᴄᴀ ᴀɴᴅ ᴇᴜᴄᴅ ʀᴇɢᴜʟᴀᴛɪᴏɴs.

Iғ yᴏᴜ ʙᴇʟɪᴇᴠᴇ ᴀɴʏ ᴄᴏɴᴛᴇɴᴛ vɪᴏʟᴀᴛᴇs ᴛʜᴇ ʟᴀᴡ, pʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ ᴜs ɪᴍᴍᴇᴅɪᴀᴛᴇʟʏ sᴏ ɪᴛ ᴄᴀɴ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ prᴏᴍᴘᴛʟʏ. ɪᴛ ɪs sᴛʀɪᴄᴛʟʏ ᴘʀᴏʜɪʙɪᴛᴇᴅ tᴏ ᴅᴏᴡɴʟᴏᴀᴅ, sᴛʀᴇᴀᴍ, ʀᴇᴘʀᴏᴅᴜᴄᴇ, sʜᴀʀᴇ, ᴏʀ ᴄᴏɴsᴜᴍᴇ, ᴀɴʏ ᴄᴏɴᴛᴇɴᴛ wɪᴛʜᴏᴜᴛ ᴇxᴘʟɪᴄɪᴛ pᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ ᴄʀᴇᴀᴛᴏʀ ᴏʀ ʟᴇɢᴀʟ ᴄᴏᴘʏʀɪɢʜᴛ hᴏʟᴅᴇʀ.

Iғ yᴏᴜ ʙᴇʟɪᴇᴠᴇ tʜɪs ʙᴏᴛ ɪs ɪɴғʀɪɴɢɪɴɢ ᴏɴ yᴏᴜʀ ɪɴᴛᴇʟʟᴇᴄᴛᴜᴀʟ pʀᴏᴘᴇʀᴛʏ ʀɪɢʜᴛs, pʟᴇᴀsᴇ ʀᴇᴀᴄʜ ᴏᴜᴛ tᴏ ᴛʜᴇ ᴀᴘᴘʀᴏᴘʀɪᴀᴛᴇ ᴄʜᴀɴɴᴇʟs ғᴏʀ ᴄᴏɴᴛᴇɴᴛ ʀᴇᴍᴏᴠᴀʟ. tʜᴇ ʙᴏᴛ dᴏᴇs ɴᴏᴛ ᴏᴡɴ ᴀɴʏ ᴏғ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ; ɪᴛ ᴏɴʟʏ ɪɴᴅᴇxᴇs ғɪʟᴇs fʀᴏᴍ ᴛᴇʟᴇɢʀᴀᴍ.</b>"""
