...
USERNAME = environ.get('USERNAME', "@bluedragon340")
...
URL = environ.get('URL', 'central-timi-filmyadd.koyeb.app/')
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002428338297')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002452722005'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002456624365'))
